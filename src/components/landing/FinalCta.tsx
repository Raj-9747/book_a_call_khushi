  ...
  return (
    <section className="border-t border-border bg-surface-muted py-20 sm:py-24">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="relative overflow-hidden rounded-2xl bg-neutral-900 px-6 py-14 text-center sm:px-12 sm:py-16">
          <div
            aria-hidden="true"
          ...
          <div className="relative">
            ...
            <Link
              ...
              className="mt-8 inline-flex items-center gap-2 rounded-md bg-white px-6 py-3 text-sm font-medium text-neutral-900 shadow-sm transition-colors hover:bg-neutral-100"
            >
